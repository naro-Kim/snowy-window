  ...
  return (
    <>
      <Html position={[0, 2.1, 0]} scale={0.15} className={`transition-all duration-500 ${showUI ? "opacity-100" : "opacity-0"}`} transform center distanceFactor={5}>
        <div className="transform scale-1000 text-pretty border-2 border-solid rounded-lg bg-[rgba(0,0,0,0.2)] border-[rgba(0,0,0,0.1)] p-2">
          <h1 className="font-semibold text-[0.3rem]">
            {'Snowman'}
          </h1>
          <span className="text-[0.3rem] text-slate-300">
            <p>{`Cheers to 2024! >-<`}</p>
          </span>
        </div>
      </Html>
